...
func init() {
	...
	utilruntime.Must(reclaimv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "14480be8.pv-reclaimer.io",
	...
	if err = (&controller.PVReclaimReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "PVReclaim")
		os.Exit(1)
	}
